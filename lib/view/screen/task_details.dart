                ...
                children: [
                  ...
                  Obx(
                    () => CustomButton(
                      ...
                      text:
                          taskController.isProgressUpdating.value == true
                              ? Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
              ...
              children: [
                ...
                Obx(
                  () => CustomButton(
                    ...
                    text:
                        taskController.isSubTaskAdding.value == true
                            ? Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                CircularProgressIndicator(color: whiteColor),
            ...
            children: [
              ...
              Obx(
                () => CustomButton(
                  ...
                  text:
                      taskController.isSubTaskEditing.value == true
                          ? Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              CircularProgressIndicator(color: whiteColor),
