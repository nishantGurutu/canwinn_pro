...
class _AddEventState extends State<AddEvent> {
  ...
  RxList<String> eventTypeList = <String>["Global", "Personal"].obs;
                            ...
                            Container(
                              ...
                              child: MultiDropdown<ResponsiblePersonData>(
                                ...
                                onSelectionChange: (selectedItems) {
                                  ...
                                  feedController.selectedGuest.assignAll(
                                    selectedItems,
                                  );
                                },
                              ),
                            ...
                            Obx(
                              () => DropdownButtonHideUnderline(
                                child: DropdownButton2<String>(
                                  ...
                                  value:
                                      selectedEventType!.value.isEmpty
                                          ? null
  ...
  void calllingAddevent() {
    ...
    CustomToast().showCustomToast(
      "Event added! Can't wait to see everyone there!",
    );
