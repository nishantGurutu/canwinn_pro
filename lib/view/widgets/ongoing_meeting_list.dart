...
class OngoingMeetingList extends StatelessWidget {
  final RxList<OngoingMeeting> meetingListData;
    ...
    return meetingListData.isEmpty
        ? Center(
          child: Column(
            ...
            spacing: 5.h,
            children: [
              Image.asset('assets/images/png/meeting_icons.png', height: 90.h),
              Text(
                'No meeting found',
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          if ((meetingListData[index].attendingUsers?.length ??
                                  0) >
                              0)
                            InkWell(
                              onTap: () {
